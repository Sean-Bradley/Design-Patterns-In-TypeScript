...
const COMPONENT1 = new component_1.Component(MEDIATOR, "Component1");
const COMPONENT2 = new component_1.Component(MEDIATOR, "Component2");
const COMPONENT3 = new component_1.Component(MEDIATOR, "Component3");
